...
#define kJBFontFooterSubLabel [UIFont fontWithName:@"HelveticaNeue-Light" size:12.0]
...
#define kJBFontInformationTitle [UIFont fontWithName:@"HelveticaNeue" size:60]
